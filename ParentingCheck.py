...
class ParentingCheck(FhirCheck):
    ...
    def check(self, entry):
        ...
        """ 
        Wir wuerden gerne checken, ob die Eltern-Kind Beziehungen zwischen Proben stimmen. 
        Wenn eine Probe Derived ist, sollte sie auf einen Parent zeigen, der entweder schon in 
        der db ist oder der in der json Datei vor der Probe kommt. 
