# automatically generated, DON'T EDIT. please edit RestmengeCheck.ct from where this file stems.
import re
...
class RestmengeCheck(FhirCheck):
    ...
    def check(self, entry):
        ...
        if (restamount is None or restamount == 0) and figs.locationpath(resource) is not None:
